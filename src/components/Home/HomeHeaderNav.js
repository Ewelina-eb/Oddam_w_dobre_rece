    ...
    <>
            <nav className="header-nav">
                <ul>
                    ...
                    <li><Link to="simple-steps" spy={true} offset={0} smooth={true} duration={500}>O co chodzi?</Link></li>
                    <li><Link to="HomeAboutUs" spy={true} offset={0} smooth={true} duration={500}>O nas</Link></li>
